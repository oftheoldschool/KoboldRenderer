...
public struct KAttachmentLayout: Sendable {
    public let name: String
    public let colorAttachments: [KColorAttachment]
    public let depthAttachment: KDepthAttachment?
}

public enum KPixelFormat: Sendable {
    case bgra8Unorm
    case rgba32Float
    case rgba16Float
    case r16Float
...
public struct KDepthAttachment: Sendable {
    public let pixelFormat: KPixelFormat

    public init(pixelFormat: KPixelFormat) {
        self.pixelFormat = pixelFormat
    }
}

public struct KColorAttachment: Sendable {
    public let pixelFormat: KPixelFormat
    public let enableTransparency: Bool

    public init(
        description: String,
        pixelFormat: KPixelFormat,
