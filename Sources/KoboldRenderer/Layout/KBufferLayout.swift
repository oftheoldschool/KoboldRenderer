public struct KBufferBindingType: CustomStringConvertible, Hashable, Sendable {
    ...
    public let datatype: KBufferDataType
...
public struct KBufferLayoutBinding: Equatable, Sendable {
...
public struct KBufferLayout: Sendable {
    public let name: String
    public let bufferLayoutBindings: [KBufferLayoutBinding]

    public init(
        name: String,
        bufferLayoutBindings: [KBufferLayoutBinding]
    ) {
        self.name = name
...
indirect public enum KBufferDataType: Hashable, Equatable, CustomStringConvertible, Sendable {
    case primitive(KMetalPrimitiveType)
    case pointer(KBufferDataType)
    case custom(String)
